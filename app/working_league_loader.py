...
"""
Sistema de Carregamento Funcional das Ligas Principais
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('working_league_loader.log'),
        logging.StreamHandler()
    ]
)
logger = logging.getLogger(__name__)

class WorkingLeagueLoader:
    def __init__(self):
