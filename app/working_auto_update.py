...
"""
Sistema Automático Funcional de Atualização
- Usa endpoints que funcionam
    ...
    def check_new_fixtures(self):
        ...
        try:
            ...
            if data and data.get("data"):
                fixtures = data["data"]
                logger.info(f"   📊 {len(fixtures)} fixtures recebidos da API")
                    ...
                    try:
                        ...
                        if fixture.get("league_id") in self.leagues_to_monitor:
                            ...
                            if fixture_date > last_update:
                                ...
                                logger.info(f"      ✅ Novo fixture: {fixture['name']} ({fixture['id']})")
                    except Exception as e:
